...
Schema::add(
    Schema::table('lkt_web_pages__metas', LaminimComponent::WebPageMetas->value)
        ...
        ->setFields([
            ...
            IntegerField::foreignKey(LaminimComponent::WebPage->value, 'webPage', 'page_id')->setDefaultValue(0),
            IntegerField::foreignKey(LaminimComponent::WebPageCategory->value, 'webCategory', 'category_id')->setDefaultValue(0),
